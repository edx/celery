...
def autodiscover_tasks(packages, related_name='tasks'):
    ...
    if _RACE_PROTECTION:
        logger.info("EDX-CELERY-RaceProtectionDenied: Access to autodiscover_tasks is denied due to race condition")
        print("EDX-CELERY-RaceProtectionDenied: Access to autodiscover_tasks is denied due to race condition")
        return ()
    _RACE_PROTECTION = True
    try:
        logger.info("EDX-CELERY-FindingRelatedModules: Access to find_related_module is acquired")
        print("EDX-CELERY-FindingRelatedModules: Access to find_related_module is acquired")
